...
for (let movie of movies) {
    (movie.year > "2017") ? console.log(true) : console.log(false);
}
...
(movies[0].title == 'Hannah') ? console.log("yes its hannah") : console.log("no");
